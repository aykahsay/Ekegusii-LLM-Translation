...
def create_backtranslation_notebook():
    print("=== Creating A100_NMT_BackTranslation_and_Orthography_Normalized.ipynb (With Model Exporter) ===")
    ...
    notebook = {
        "cells": [
            ...
            # CELL 2: ORTHOGRAPHY NORMALIZER & DATA RESOLVER
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 4: BACK-TRANSLATION SYNTHETIC DATA GENERATOR & STAGE 1/2 PRE-TRAINING
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 5: HELD-OUT TEST EVALUATION & LIVE TRANSLATION SAMPLES
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 6: PERMANENT MODEL EXPORTER & SAVER
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
    ...
    paths = [
        os.path.join(workspace_dir, "A100_NMT_BackTranslation_and_Orthography_Normalized.ipynb"),
        os.path.join(workspace_dir, "notebooks", "A100_NMT_BackTranslation_and_Orthography_Normalized.ipynb")
    ]
    
    for p in paths:
        with open(p, 'w', encoding='utf-8') as f:
            json.dump(notebook, f, indent=2)
        print(f"[OK] Back-Translation & Orthography Notebook saved to: {p}")

if __name__ == "__main__":
    create_backtranslation_notebook()
