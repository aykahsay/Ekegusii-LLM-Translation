...
def create_master_ipynb():
    print("=== Updating Master Jupyter Notebook to Filter Out Low-Quality Raw Monolingual Datasets ===")
    ...
    notebook = {
        "cells": [
            ...
            # CELL 2: DYNAMIC MULTI-FOLDER DATA RESOLVER & SPLITTER
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 3: NMT TOKENIZER & METRIC UTILITY SETUP
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 4: ARCHITECTURE 1 TRAINING
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 5: ARCHITECTURE 2 TRAINING (CONCATENATING CLEANED BILINGUAL & TRILINGUAL DATASETS)
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 6: ARCHITECTURE 3 TRAINING (FILTERED UNILINGUAL, BILINGUAL, TRILINGUAL)
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 7: COMPARATIVE EVALUATION & VISUALIZATION
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
    ...
    paths = [
        os.path.join(workspace_dir, "A100_3_Architectures_Master_Pipeline.ipynb"),
        os.path.join(workspace_dir, "notebooks", "A100_3_Architectures_Master_Pipeline.ipynb"),
        os.path.join(workspace_dir, "notebooks", "A100_3_Architectures_Master_Pipeline_edited.ipynb"),
        os.path.join(workspace_dir, "translation_model_last.ipynb"),
        os.path.join(workspace_dir, "notebooks", "translation_model_last.ipynb"),
        os.path.join(workspace_dir, "notebooks", "A100_3_Architectures_Training.ipynb")
    ]
    
    for p in paths:
        with open(p, 'w', encoding='utf-8') as f:
            json.dump(notebook, f, indent=2)
        print(f"[OK] Master Clean Notebook saved to: {p}")
