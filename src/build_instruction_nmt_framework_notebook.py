...
def create_instruction_framework_notebook():
    print("=== Creating A100_Instruction_Tuned_NMT_Framework.ipynb ===")
    ...
    notebook = {
        "cells": [
            # CELL 0: TITLE & FRAMEWORK ARCHITECTURE MARKDOWN
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 2: MODULE 1 & 2 DATASET VERIFICATION
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 3: MODULE 3 ADAPTATION ENGINE SETUP
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 4: EXECUTE INSTRUCTION-TUNING FINE-TUNING
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # CELL 5: MODULE 4 RESOURCE ATTRIBUTION REPORT
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
    ...
    paths = [
        os.path.join(workspace_dir, "A100_Instruction_Tuned_NMT_Framework.ipynb"),
        os.path.join(workspace_dir, "notebooks", "A100_Instruction_Tuned_NMT_Framework.ipynb")
    ]
    
    for p in paths:
        with open(p, 'w', encoding='utf-8') as f:
            json.dump(notebook, f, indent=2)
        print(f"[OK] Instruction Framework Notebook saved to: {p}")

if __name__ == "__main__":
    create_instruction_framework_notebook()
