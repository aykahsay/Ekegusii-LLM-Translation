...
def train(
    ...
    model_name: str = typer.Option("aya", help="'aya' or 'llama'."),
) -> None:
    """Fine-tune a model (Aya/Llama) on one experiment's resource configuration."""
...
@app.command()
def analyze(model_key: str = typer.Option("aya", help="'aya' or 'llama'.")) -> None:
