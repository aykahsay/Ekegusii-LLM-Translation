...
# once training (train_qwen.sh / train_mistral.sh) has produced them.
# ==============================================================================

set -e

echo "======================================================================"
echo "Evaluating Qwen2.5-7B-Instruct and Mistral-7B-Instruct-v0.3 (zero-shot baseline, E0)"
echo "======================================================================"

python -m src.cli.main run-eval --model-name qwen --source-lang English --target-lang Ekegusii
python -m src.cli.main run-eval --model-name mistral --source-lang English --target-lang Ekegusii
