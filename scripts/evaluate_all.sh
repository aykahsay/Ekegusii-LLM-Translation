...
# once training (train_aya.sh / train_llama.sh) has produced them.
# ==============================================================================

set -e

echo "======================================================================"
echo "Evaluating Aya-23-8B and Llama-3.1-8B (zero-shot baseline, E0)"
echo "======================================================================"

python -m src.cli.main run-eval --model-name aya --source-lang English --target-lang Ekegusii
...
echo "  python -m src.cli.main run-eval --model-name aya --adapter-path checkpoints/aya/E4_Trilingual/checkpoint-1500"
